...
<x-layouts.main :title="$title">
    ...
    <div>
        <div
            class="fixed flex items-center justify-center top-0 left-0 z-30 bg-pink-100 text-pink-800 text-xs font-medium me-2 px-2.5 py-0.5 rounded dark:bg-pink-900 dark:text-pink-300 uppercase">
            <x-tabler-brand-livewire class="w-4 h-4 mr-2" />
            <span>Livewire Mode</span>
        </div>
        <!-- Header : Navbar -->
        <header class="md:sticky md:top-0 md:z-10">
            <!-- Primary Nav -->
            <nav class="bg-white border-gray-200 px-4 lg:px-6 py-2.5 dark:bg-gray-800">
                <div class="flex flex-wrap items-center justify-between max-w-screen-xl mx-auto">
                    <x-ui.link :href="route('home')" class="uppercase tracking-widest md:tracking-[.55em] flex items-center">
                        <x-ui.application-logo class="h-6 mr-3 sm:h-9" fill="currentColor" />
                        {{-- <img src="https://flowbite.com/docs/images/logo.svg" class="h-6 mr-3 sm:h-9" alt="Flowbite Logo" /> --}}
                        <span
                            class="self-center text-xl font-semibold whitespace-nowrap dark:text-white xs:block xxs:hidden">{{ __('index.brand') }}
                        </span>
                    </x-ui.link>
                    ...
                    <div class="flex items-center justify-center">
                        <ul class="flex flex-row mt-0 mr-6 space-x-8 text-sm font-medium">
                            ...
                            <li class="hidden md:inline">
                                <a href="#"
                                    class="text-gray-900 dark:text-white hover:underline">Marketplace</a>
                            </li>
                            <li class="hidden md:inline">
                        ...
                        <button id="dropdownDefault" data-dropdown-toggle="dropdown" data-dropdown-placement="bottom"
                            ...
                            <svg class="w-5 h-5 text-gray-700 dark:text-gray-400" fill="currentColor"
                ...
                <div class="grid grid-cols-2 gap-8 lg:grid-cols-6">
                    <div class="col-span-2">
                        <x-ui.link :href="`/`" preserve-scroll
                            ...
                            <svg class="h-8 mr-2" viewBox="0 0 33 33" fill="none"
                                xmlns="http://www.w3.org/2000/svg">
                                <path
                        ...
                        <p class="my-4 font-light text-gray-500 dark:text-gray-400">Flowbite is a open-source library
                            of
                            over 400+ web components and interactive elements built with the utility classes from
                            Tailwind
                            CSS.</p>
