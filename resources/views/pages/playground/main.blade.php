...
<x-main-layout :title="__('index.welcome')">
    <div class="grid max-w-screen-xl grid-cols-1 px-4 pt-6 mx-auto xl:grid-cols-3 xl:px-0 xl:gap-4 dark:bg-gray-900">
        <div class="mb-4 col-span-full xl:mb-2">
            ...
            <h1 class="text-xl font-semibold text-gray-900 sm:text-2xl dark:text-white">Create something awesome here
            </h1>
        </div>
        <!-- Right Content -->
