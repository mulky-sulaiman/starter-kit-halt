<section>
    ...
    <form method="post" action="{{ route('password.update') }}" class="mt-6 space-y-6">
        ...
        <div>
            ...
            <!-- Current Password -->
            <x-forms.input :label="__('Current Password')" :hint="__('register.password_hint')" type="password" id="update_password_current_password"
                name="update_password_current_password" autocomplete="current-password" required />
