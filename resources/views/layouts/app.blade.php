                        ...
                        <div class="flex items-center justify-start">
                            ...
                            <x-ui.link :href="route('home')"
                                ...
                                {{-- <img src="https://flowbite.com/docs/images/logo.svg" class="h-8 mr-3"
                                    alt="FlowBite Logo" /> --}}
                                <x-ui.application-logo class="h-8 mr-3" fill="currentColor" />
                                <span
                                    class="self-center text-xl font-semibold whitespace-nowrap xs:block xxs:hidden">{{ __('index.brand') }}</span>
                            </x-ui.link>
