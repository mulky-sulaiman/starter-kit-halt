                ...
                <div class="px-3 py-3 lg:px-5 lg:pl-3">
                    <div class="flex items-center justify-between">
                        <div class="flex items-center justify-start">
                            ...
                            <x-ui.link :href="`/`" class="flex ml-2 tracking-widest uppercase md:mr-24">
                                <img src="https://flowbite.com/docs/images/logo.svg" class="h-8 mr-3"
                                    alt="FlowBite Logo" />
                                <span
                                    class="self-center text-xl font-semibold whitespace-nowrap dark:text-white xs:block xxs:hidden">{{ __('index.brand') }}</span>
                            </x-ui.link>
        ...
        <div class="flex pt-16 overflow-hidden bg-gray-50 dark:bg-gray-900">
                            ...
                            <ul class="pb-2 space-y-2">
                                ...
                                <li>
                                    <button type="button"
                                        ...
                                        aria-expanded="@if (request()->routeIs('permission.index')) true @else false @endif">
                                        <x-tabler-users-group
                                            class="flex-shrink-0 w-6 h-6 text-gray-500 transition duration-75 group-hover:text-gray-900 dark:text-gray-400 dark:group-hover:text-white" />
                                        <span class="flex-1 ml-3 text-left whitespace-nowrap"
                                            sidebar-toggle-item="">{{ __('User Management') }}</span>
                                    ...
                                    <ul id="user-management-menu"
                                        class="py-2 space-y-2 @if (request()->routeIs('permission.index')) @else hidden @endif">
                                        @if (auth()->user()->hasRole(App\Enums\RoleEnum::SUPER_ADMIN->value))
                                            <!-- Permission -->
                                            <li>
                                                <x-ui.link href="{{ route('permission.index') }}"
            ...
            <div id="main-content"
                                        ...
                                        <ol
                                            ...
                                            <li class="inline-flex items-center">
                                                <a href="#"
                                                    ...
                                                    <svg class="w-5 h-5 mr-2.5" fill="currentColor"
                                                        viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
                                                        <path
                ...
                <p class="my-10 text-sm text-center text-gray-500">
                    © 2019-2023 <a href="https://flowbite.com/" class="hover:underline"
                        target="_blank">Flowbite.com</a>. All
                    rights reserved.
                </p>
            </div>
